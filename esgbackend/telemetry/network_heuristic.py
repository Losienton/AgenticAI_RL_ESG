...
class NetworkHeuristicManager:
    ...
    def __init__(self, step_duration: float = 10.0, min_link_state_duration: float = 30.0):
        ...
        # Link topology - matched to UNL test-for-build.unl network_id physical links
        # Fixed 2026-03-10: corrected to 33 actual physical links
        hardcoded_links = [
            (0, 1),  # S1-S2
            (0, 2),  # S1-S3
            (0, 3),  # S1-S4
        ...
        # Convert to bidirectional pairs (total: 66 pairs = 33 links x 2)
        self._pairs = []
